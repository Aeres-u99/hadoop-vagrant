# download
cd ~
wget -c https://mirrors.koehn.com/apache/hadoop/common/stable/hadoop-3.2.1.tar.gz

# unzip and move to /usr/local/bin/hadoop
sudo tar -xvzf hadoop-3.2.1.tar.gz -C /usr/local/bin/
sudo mv /usr/local/bin/hadoop-3.2.1 /usr/local/bin/hadoop/
